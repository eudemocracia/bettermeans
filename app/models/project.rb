...
class Project < ActiveRecord::Base
  ...
  # make sure we set settings required by site 
  before_save :enforce_site_requirements
  ...
  def enabled_module_names=(module_names)
    if module_names && module_names.is_a?(Array)
      ...
      # ensure modules allowed
      module_names.reject!{|name| !Setting.allowed_projects_modules.include?(name)}
